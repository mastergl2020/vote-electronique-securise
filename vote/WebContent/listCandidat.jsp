      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <span class="btn btn-theme start">
                    <i class="glyphicon glyphicon-plus"></i>
                    <span><a href=addC.jsp>Ajouter Candidat</a></span>
                  
                  </span>
              <h4><i class="fa fa-angle-right"></i> Listes Candidats</h4>
              <hr>
...
<td>
<a href="updateC.jsp?id_candidats=<%=rs.getInt(1)%>"  class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a> &nbsp;&nbsp;&nbsp;
<a href="deleteC.jsp?id_candidats=<%=rs.getInt(1)%>"  class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a></td> 
