...
st=con.prepareStatement("select *  from candidat where id_candidats='"+id+"'");
...
<div id="login-page">
    <div class="container">
      <form class="form-login" action="AjouterC" method="post">
        <h2 class="form-login-heading">Modfier Candidat</h2>
        <div class="login-wrap">
           
          <input type="text" class="form-control"  name="nom_c"  value="<%=rs.getString(2)%>"autofocus required>
          <br>
          <input type="text" class="form-control"  name="prenom_c"  value="<%=rs.getString(3)%>" required>
          <br>
          <input type="text" class="form-control"  name="partie_c"  value="<%=rs.getString(4)%>"autofocus required>
          <br>
          
          <input type="file" class= name="image"  value="<% Blob bl=rs.getBlob(6);
          ...
          <br>
          <input class="btn btn-theme btn-block" type="submit"  value="Modifier" name="op"></a> 
